			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<div class="easyui-panel" title="${sessionScope.SELECT}-编辑" style="width:100%;max-width:400px;padding:30px 60px;">
						<form id="ff" method="post" action="${pageContext.request.contextPath}/sys_projects/update_dynamic.do?id=${project._id}">
							<div style="margin-bottom:20px">
								<label>工资号</label>

								<input class="easyui-textbox" name="salary_id" value="${project.salary_id}" style="width:100%" data-options="required:true">
							</div>
							<div style="margin-bottom:20px">
								<label>项目负责人</label>

								<input class="easyui-textbox" name="name" value="${project.name}" style="width:100%" data-options="required:true">
							</div>
							<div style="margin-bottom:20px">
								<label>横向/纵向</label>
								...
								<select class="easyui-combobox"  name="type" style="width:100%">
									...
									<c:if test="${project.type==false}">
										...
										<option value="0" selected>纵向</option>
									</c:if>
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="budget_in_acc" value="${project.budget_in_acc}" style="width:100%" data-options="required:true">
					        </div>
