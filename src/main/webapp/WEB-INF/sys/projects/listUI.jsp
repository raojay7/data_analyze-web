...
<body>
			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<form id="form" method="post">
						...
						<table class="easyui-datagrid" title="${sessionScope.SELECT}-科研项目" style="width:100%;height:458px">
						<thead>

						<tr>
							<th data-options="field:'salary_id',width:160,halign:'center'">工资号</th>
							<th data-options="field:'name',width:160,halign:'center'">项目负责人</th>
							<th data-options="field:'v_or_h',width:160,halign:'center'">横向/纵向</th>
							<th data-options="field:'budget_in_acc',width:120,halign:'center'">到账经费</th>
                        ...
                        <c:forEach items="${pageResult.list}" var="item">
                          ...
                          <tr>
							...
							<td>${item.budget_in_acc}</td>


							<td>
								<a class="l-btn" href="${pageContext.request.contextPath}/sys_projects/editUI.do?id=${item._id}"> 编辑</a>
								&nbsp;&nbsp;&nbsp;
								<a class="l-btn" href="${pageContext.request.contextPath}/sys_projects/delete_dynamic.do?id=${item._id}"> 删除</a>
						...
						<tr>
							...
							<td>
								<form method="post" action="${pageContext.request.contextPath}/sys_projects/selectPageListDynamic.do">
							...
							<td>
								<a class="l-btn" href="${pageContext.request.contextPath}/sys_projects/addUI.do"> 添&nbsp;&nbsp;加</a>
							</td>
	...
	<script language="javascript">
        ...
        function doGoPage(pageNo) {
            ...
            document.forms[0].action = "${pageContext.request.contextPath}/sys_projects/selectPageListDynamic.do?pageNo="+pageNo;
