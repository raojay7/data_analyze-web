			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<div class="easyui-panel" title="${sessionScope.SELECT}-编辑" style="width:100%;max-width:400px;padding:30px 60px;">
						<form id="ff" method="post" action="${pageContext.request.contextPath}/sys_teachsum/update_dynamic.do?id=${teachsum._id}">
							<div style="margin-bottom:20px">
								<label>所属学院</label>

								<input class="easyui-textbox" name="department" value="${teachsum.department}" style="width:100%" data-options="required:true">
							</div>
							<div style="margin-bottom:20px">
								<label>工资号</label>

								<input class="easyui-textbox" name="salary_id" value="${teachsum.salary_id}" style="width:100%" data-options="required:true">
							</div>
							<div style="margin-bottom:20px">
								<label>姓名</label>

								<input class="easyui-textbox" name="name" value="${teachsum.name}" style="width:100%" data-options="required:true">
							</div>
							<div style="margin-bottom:20px">
								<label>年份</label>

								<input class="easyui-textbox" name="year" value="${teachsum.year}" style="width:100%" data-options="required:true">
					        </div>

							<div style="margin-bottom:20px">
								<label>教学工作量</label>
								<input class="easyui-textbox" name="teach_workload" value="${teachsum.teach_workload}" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>带生工作量</label>

								<input class="easyui-textbox" name="mentor_load" value="${teachsum.mentor_load}" style="width:100%" data-options="required:true">
							</div>
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="reform_workload" value="${teachsum.reform_workload}" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>总工作量</label>

								<input class="easyui-textbox" name="sum_workload" value="${teachsum.sum_workload}" style="width:100%" data-options="required:true">
							</div>
