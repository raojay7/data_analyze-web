			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<div class="easyui-panel" title="${sessionScope.SELECT}-添加" style="width:100%;max-width:400px;padding:30px 60px;">
						<form id="ff" method="post" action="${pageContext.request.contextPath}/sys_teachsum/add.do">
							<div style="margin-bottom:20px">
								<label>所属学院</label>

								<input class="easyui-textbox" name="department" style="width:100%" data-options="required:true">
							</div>
							<div style="margin-bottom:20px">
								<label>工资号</label>
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="year" style="width:100%" data-options="required:true">
					        </div>

							<div style="margin-bottom:20px">
								<label>教学工作量</label>
								<input class="easyui-textbox" name="teach_workload" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>带生工作量</label>

								<input class="easyui-textbox" name="mentor_load" style="width:100%" data-options="required:true">
							</div>
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="reform_workload" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>总工作量</label>

								<input class="easyui-textbox" name="sum_workload" style="width:100%" data-options="required:true">
							</div>
