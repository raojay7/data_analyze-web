...
<body>
			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<form id="form" method="post">
						...
						<table class="easyui-datagrid" title="${sessionScope.SELECT}-研究生教学工作量" style="width:100%;height:458px">
						<thead>



						<tr>
							<th data-options="field:'department',width:100,halign:'center'">所属学院</th>
							<th data-options="field:'salary_id',width:100,halign:'center'">工资号</th>
							<th data-options="field:'name',width:100,halign:'center'">姓名</th>
							<th data-options="field:'year',width:120,halign:'center'">年份</th>

							<th data-options="field:'teach_workload',width:180,halign:'center'">教学工作量</th>
							<th data-options="field:'mentor_load',width:180,halign:'center'">带生工作量</th>
							<th data-options="field:'reform_workload',width:120,halign:'center'">教改工作量</th>
							<th data-options="field:'sum_workload',width:120,halign:'center'">总工作量</th>
						...
						<tr>
							...
							<td>${item.teach_workload}</td>
							<td>${item.mentor_load}</td>
							<td>${item.reform_workload}</td>
							<td>${item.sum_workload}</td>



							<td>

								<a class="l-btn" href="${pageContext.request.contextPath}/sys_teachsum/editUI.do?id=${item._id}"> 编辑</a>
								&nbsp;&nbsp;&nbsp;
								<a class="l-btn" href="${pageContext.request.contextPath}/sys_teachsum/delete_dynamic.do?id=${item._id}"> 删除</a>
						...
						<tr>
							...
							<td>
								...
								<form method="post" action="${pageContext.request.contextPath}/sys_teachsum/selectPageListDynamic.do">
							...
							<td>
								<a class="l-btn" href="${pageContext.request.contextPath}/sys_teachsum/addUI.do"> 添&nbsp;&nbsp;加</a>
							</td>
							<td>
	...
	<script language="javascript">
        ...
        function doGoPage(pageNo) {
            ...
            document.forms[0].action = "${pageContext.request.contextPath}/sys_teachsum/selectPageListDynamic.do?pageNo="+pageNo;
