			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<div class="easyui-panel" title="${sessionScope.SELECT}-添加" style="width:100%;max-width:400px;padding:30px 60px;">
						<form id="ff" method="post" action="${pageContext.request.contextPath}/sys_teach/add.do">
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="rank" style="width:100%" data-options="required:true">
							</div>
							<div style="margin-bottom:20px">
								<label>职务</label>

								<input class="easyui-textbox" name="duty" style="width:100%" data-options="required:true">
					        </div>

							<div style="margin-bottom:20px">
								<label>理论课折合学时(上半年)</label>
								<input class="easyui-textbox" name="theory_fs" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>专业技术人员兼职补贴学时(上)</label>

								<input class="easyui-textbox" name="profession_fs" style="width:100%" data-options="required:true">
							</div>
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="ready_fs" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>指导实验学时(上)</label>

								<input class="easyui-textbox" name="guide_fs" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>毕业论文、设计学时；实习、课程设计、社会调查学时(上)</label>

								<input class="easyui-textbox" name="graduation_fs" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>上半年合计</label>

								<input class="easyui-textbox" name="first_sum" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>理论课折合学时(下半年)</label>

								<input class="easyui-textbox" name="theory_ss" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>专业技术人员兼职补贴学时(下)</label>

								<input class="easyui-textbox" name="profession_ss" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>准备实验学时(下)</label>

								<input class="easyui-textbox" name="ready_ss" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>指导实验学时(下)</label>

								<input class="easyui-textbox" name="guide_ss" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>毕业论文、设计学时；实习、课程设计、社会调查学时(下)</label>

								<input class="easyui-textbox" name="graduation_ss" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>下半年合计</label>

								<input class="easyui-textbox" name="second_sum" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>备注(关键岗)</label>

								<input class="easyui-textbox" name="remark_job" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>全年度合计</label>

								<input class="easyui-textbox" name="year_sum" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>二类通识课，重修班，个性课单独开班课程工作量</label>

								<input class="easyui-textbox" name="second_etc" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>创新课程工作量</label>

								<input class="easyui-textbox" name="innovative_course" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>学院算岗贴工作量</label>

								<input class="easyui-textbox" name="college_workload" style="width:100%" data-options="required:true">
							</div>
