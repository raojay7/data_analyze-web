			...
			<div class="grid_wrapper">
				...
				<div class="g_12">
					...
					<div class="easyui-panel" title="${sessionScope.SELECT}-添加" style="width:100%;max-width:400px;padding:30px 60px;">
						<form id="ff" method="post" action="${pageContext.request.contextPath}/sys_papers/add.do">
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="ids_num" style="width:100%" data-options="required:true">
							</div>

							<div style="margin-bottom:20px">
								<label>年份</label>

								<input id="dd" class="easyui-datetimebox" type="datetime" name="year" style="width:100%" data-options="required:true" >
							...
							<div style="margin-bottom:20px">
								...
								<input class="easyui-textbox" name="author" style="width:100%" data-options="required:true">
					        </div>

							<div style="margin-bottom:20px">
								<label>刊物级别</label>
								<input class="easyui-textbox" name="level" style="width:100%" data-options="required:true">
							</div>
